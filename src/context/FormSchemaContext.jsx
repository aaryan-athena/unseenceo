...
export const DEFAULT_VENTURE_FIELDS = [
  ...
  { id: 'v6',  key: 'sector',               label: 'Sector',                       type: 'select',   required: true,  placeholder: '',  options: ['Food & Catering', 'Textiles & Handloom', 'Beauty & Wellness', 'Agriculture & Dairy', 'Retail & Trading', 'Handicrafts & Artisanal', 'Healthcare & Childcare', 'Education & Tutoring', 'Transport & Logistics', 'Technology & Digital', 'Construction & Home Services', 'Finance & Microfinance', 'Other'], section: 'Business Details', order: 6, storeAsArray: false },
  { id: 'v7',  key: 'businessType',         label: 'Business Type',                type: 'select',   required: true,  placeholder: '',  options: ['Home-based', 'Street Vendor / Stall', 'Small Shop / Retail', 'Service Provider', 'Manufacturing / Production', 'Online / E-commerce', 'Cooperative / SHG', 'Franchise', 'Other'], section: 'Business Details', order: 7, storeAsArray: false },
